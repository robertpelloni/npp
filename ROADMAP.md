...
- [x] Audit Geany features missing from Notepad++ (e.g., integrated VTE/Terminal, advanced symbol tree).
...
- [x] Implement a fully functional Vertical Tabs dockable pane, replicating all context menu actions of the standard horizontal tab bar.
- [x] Implement a theming engine capable of skinning standard Win32 controls, borders, and scrollbars to achieve the "glass" look.
